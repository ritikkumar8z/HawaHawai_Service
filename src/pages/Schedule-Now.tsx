...
const ContactPage: React.FC<{ title: string; description: string; buttonText?: string }> = ({ title, description, buttonText }) => {
...
const ContactPages = () => {
  return (
    <>
      {/* <ContactPage title="Let's Talk" description="We'd love to hear from you! Let's discuss your project and bring your ideas to life." buttonText="Get in Touch" /> */}
      {/* <ContactPage title="Contact Our Team" description="Our experts are ready to assist you. Reach out and let's make something amazing together!" buttonText="Reach Out" /> */}
      <ContactPage title="Book a Call" description="Schedule a meeting with our professionals and take the next step in your journey." buttonText="Schedule Now" />
      {/* <ContactPage title="Let's Chat" description="Have questions? Need support? Chat with us and get instant assistance!" buttonText="Start Chat" /> */}
    </>
  );
};
